...
model = load_model('C:/Users/DIVYA DHARSHAN/Desktop/catch chatbot/CounselBot/botmodel.h5')
tok = joblib.load('C:/Users/DIVYA DHARSHAN/Desktop/catch chatbot/CounselBot/tokenizer_t.pkl')
words = joblib.load('C:/Users/DIVYA DHARSHAN/Desktop/catch chatbot/CounselBot/words.pkl')
df2 = pd.read_csv('C:/Users/DIVYA DHARSHAN/Desktop/catch chatbot/CounselBot/bot.csv')
flag=1
...
def main():
    ...
    def inpenc(tok,df,c):
        ...
        # Ensure the padded sequence length matches the model's expected input shape
    ...
    qvals = {"Select an Option": 0, "Strongly Agree": 5, "Agree": 4, "Neutral": 3, "Disagree": 2,
             "Strongly Disagree": 1}
    st.title("WAY 2 CAREER BOT")
    banner=Image.open("C:/Users/DIVYA DHARSHAN/Desktop/catch chatbot/CounselBot/img/21.png")
    st.image(banner, use_column_width=True)
    st.write("Hi! I'm WAY 2 CAREER BOT, your personal career counseling bot. Ask your queries in the text box below and hit enter. If and when you are ready to take our personality test, type \"start my test\" and you're good to go!")

    df3 = get_text()
    if (df3.loc[0, 'user']==""):
        ans = "Hi, I'm WAY 2 CAREER BOT. \nHow can I help you?"
    ...
    st.text_area("WAY 2 CAREER", value=ans, height=100, max_chars=None)
